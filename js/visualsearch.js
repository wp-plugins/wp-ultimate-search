...
(function() {
	...
	VS.ui.SearchBox = Backbone.View.extend({
		...
		initialize:          function() {
			...
			this.app.searchQuery.bind('reset', this.renderFacets).bind('add', this.addedFacet).bind('remove', this.removedFacet).bind('change', this.changedFacet);
		...
		focusNextFacet:      function(currentView, direction, options) {
			...
			} else if(options.skipToFacet && currentView.type == 'text' && viewCount == viewPosition && direction >= 0) {
...
(function() {
	...
	VS.model.SearchQuery = Backbone.Collection.extend({
		...
		withoutCategory: function(category) {
			return this.map(function(facet) {
				if(facet.get('category') != category) {
					return facet.serialize();
				}
			}).join(' ');
		}
...
(function() {
	...
	window.JST['search_box'] = _.template('<div class="VS-search">\n  <div class="VS-search-box-wrapper VS-search-box">\n    <div class="VS-icon VS-icon-search"></div>\n    <div class="VS-search-inner"></div>\n    <div id="vs-cancel" class="VS-icon VS-icon-cancel VS-cancel-search-box" title="clear search"></div>\n  </div>\n</div>');
...
//VS.model.searcher = Backbone.Router.extend({
//	routes: {
//		"search/:query": "search"  // matches http://example.com/#search/query
//	},
...
//});
// Initiate the router
//VS.app.searcher = new VS.model.searcher;
